...
htseq-count -f bam -r pos -t CDS -i ID $bams$number$location.bam no_fasta$VAR.gff > $outfolderD1_bin$VAR.txt
htseq-count -f bam -r pos -t CDS -i ID $bams$number$location2.bam no_fasta$VAR.gff >  $outfolderD3_bin$VAR.txt
